#
# This python script uses the sagemcom API to grab bytes sent and received from the Fiber and 10Gbaset-T port on a Bell GigaHub 2.0 and send the data to InfluxDB
# 
